  ...
  loadProjects() {
      const projectsData = [
          ...
          new Project(
              ...
              'Comprehensive social media scheduling and analytics tool with AI-powered content suggestions.',
              ['Vue.js', 'Express', 'Redis', 'AWS'],
              'https://github.com/yourusername/social-tool',
              'https://images.unsplash.com/photo-1611162617474-5b21e879e113?w=800&h=600&fit=crop&q=80'
          ),
          new Project(
              'Real-Time Collaboration Platform',
              'Team collaboration platform with video conferencing, document editing, and project management features.',
              ['React', 'WebRTC', 'Socket.io', 'Docker'],
              'https://github.com/yourusername/collab-platform',
              'https://images.unsplash.com/photo-1552664730-d307ca884978?w=800&h=600&fit=crop&q=80'
          ),
          new Project(
              'Fitness Tracking Mobile App',
              'Cross-platform fitness app with workout plans, nutrition tracking, and social features.',
              ['React Native', 'Firebase', 'GraphQL'],
              'https://github.com/yourusername/fitness-app',
              'https://images.unsplash.com/photo-1461896836934-ffe607ba8211?w=800&h=600&fit=crop&q=80'
          ),
          new Project(
              'Blockchain Voting System',
              'Secure and transparent voting platform built on blockchain technology for organizational elections.',
              ['Solidity', 'Ethereum', 'React', 'Web3.js'],
              'https://github.com/yourusername/voting-blockchain',
              'https://images.unsplash.com/photo-1639762681485-074b7f938ba0?w=800&h=600&fit=crop&q=80'
          )
      ];
